...
import 'package:jaydip_whatsapp_ui/model/message/message_helper.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Icon(
              // darkModeOn ? Icons.dark_mode_outlined : Icons.light_mode_outlined,
              Icons.videocam,
            ),
          ),
          Padding(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            image: AssetImage(Theme.of(context).brightness == Brightness.dark
                ? "assets/images/wh_dark_bg3.jpg"
                : "assets/images/wh_bg1.png"),
          ),
        ),
        child: SafeArea(
          child: Column(
            ...
            children: [
              Expanded(
                child: ListView.builder(
                    itemCount: MessageServices.itemCount,
                    itemBuilder: (context, index) {
                      MessageModel chatItem =
                          MessageServices.getCHatList(index);
                      return Column(
                        ...
                        children: [
                          MessageBubble(
                            ...
                            onPress: () {},
                            listLength: MessageServices.itemCount,
                            type: chatItem.type,
                          )
                        ],
                      );
